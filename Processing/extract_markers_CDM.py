...
if __name__ == '__main__':
    ...
    #rootdir = "D:/Trout_Pilot5/Eyetracking/"            
...
#                markers = marker_positions('sdcalib.rmap.full.camera.pickle', vid_path, path + 'markers.npy', path, visualize = False, correct_gaze = True, rewrite = rewrite)
                markers = marker_positions('sdcalib.rmap.full.camera_unix.pickle', vid_path, path + 'markers.npy', path, visualize = False, correct_gaze = True, rewrite = rewrite)
