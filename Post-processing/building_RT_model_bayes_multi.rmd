...
load("m3_varying_shapewithttlc_balancedonly.rda")
...
pp_check(m3.1.2)
pp_check(m3.1) #doesn't quite capture the peaks
...
ggplot(cogload_contrast, aes(x = mn_diff)) + geom_density() + xlim(0,.5)


ggsave("individual_prediction_intervals.png", plot = last_plot(), type = "cairo")
ggsave("cogloadcontrast_m3-1.png", plot = last_plot(), type = "cairo")
ggsave("balanced_predicted_distributions_m3-1.png", plot = last_plot(), type = "cairo")
