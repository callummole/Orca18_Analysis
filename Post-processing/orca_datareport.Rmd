...
The pre-registration specifies two steering related hypotheses:
...
Fig 3 shows massive differences in how quickly drivers disengage the automation after the yawrate onset. In the _None_ condition drivers disengaged the system in `r as.double(disengage_perc) * 100` % of trials. Since drivers react at such different speeds across the three failure types the failure type conditions will be look at in turn.
