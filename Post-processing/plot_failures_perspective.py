...
legend_elements = [Line2D([0],[0],color = rgbas[0], lw = 2, label = "1.93 s"),
				...
				Line2D([0],[0], color = "xkcd:light grey", lw = 2, label = "Non-Repeated")] 


axes[0,1].legend(handles = legend_elements, loc = [.5,.02], fontsize = 8, frameon = False, title = r'$TTLC_F$', title_fontsize = 8, labelspacing = .4)
